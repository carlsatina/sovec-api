...
const VALID_STATUSES = ['FINDING_DRIVER', 'ASSIGNED', 'ARRIVING', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED'];
...
router.post('/:id/rate', requireAuth, async (req, res) => {
    ...
    if (existingRating)
        return res.status(409).json({ error: 'Rating already submitted for this ride' });
